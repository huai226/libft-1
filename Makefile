...
#    Updated: 2017/12/12 19:02:47 by slin             ###   ########.fr        #
#                                                                              #
#******************************************************************************#
...
SRC		= 	ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c \
			...
			ft_strncpy.c ft_strrchr.c ft_tolower.c ft_toupper.c \
			...
			ft_strlen_char.c ft_strrev.c ft_recursive_factorial.c \
			ft_iterative_factorial.c ft_print_bits.c
